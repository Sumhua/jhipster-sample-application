package com.westmei.casher.web.rest;

import static com.westmei.casher.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.westmei.casher.IntegrationTest;
import com.westmei.casher.domain.Department;
import com.westmei.casher.repository.DepartmentRepository;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().departmentName(DEFAULT_DEPARTMENT_NAME).price(DEFAULT_PRICE);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().departmentName(UPDATED_DEPARTMENT_NAME).price(UPDATED_PRICE);
        return department;
    }
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getPrice()).isEqualByComparingTo(DEFAULT_PRICE);
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).price(UPDATED_PRICE);
        ...
        assertThat(testDepartment.getPrice()).isEqualTo(UPDATED_PRICE);
    }
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.price(UPDATED_PRICE);
        ...
        Department testDepartment = departmentList.get(departmentList.size() - 1);
        assertThat(testDepartment.getDepartmentName()).isEqualTo(DEFAULT_DEPARTMENT_NAME);
        assertThat(testDepartment.getPrice()).isEqualByComparingTo(UPDATED_PRICE);
    }
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).price(UPDATED_PRICE);
