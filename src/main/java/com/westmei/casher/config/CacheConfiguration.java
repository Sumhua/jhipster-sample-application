package com.westmei.casher.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.westmei.casher.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.westmei.casher.repository.UserRepository.USERS_BY_EMAIL_CACHE);
