      ...
      <table class="table table-striped" aria-describedby="departments">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.department.departmentName')">Department Name</span></th>
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.department.price')">Price</span></th>
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.department.location')">Location</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
