    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.department.price')" for="department-price"
              >Price</label
            >
            <input
              type="number"
              ...
              id="department-price"
              data-cy="price"
              :class="{ valid: !$v.department.price.$invalid, invalid: $v.department.price.$invalid }"
              v-model.number="$v.department.price.$model"
              required
            />
            <div v-if="$v.department.price.$anyDirty && $v.department.price.$invalid">
              <small class="form-text text-danger" v-if="!$v.department.price.required" v-text="$t('entity.validation.required')">
                This field is required.
              </small>
              <small class="form-text text-danger" v-if="!$v.department.price.numeric" v-text="$t('entity.validation.number')">
